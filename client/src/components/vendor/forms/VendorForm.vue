<template>
  <q-card style="height: 100%; width: 100%">
    <div class="q-pa-md" style="width: 100%; position:  relative">
      <q-img style="width: 100%; height: 425px; border-radius: 6px" :src="getAvatar(form, 'img', 'large', null, 'https://cdn.quasar.dev/img/material.png')">
        ...
        <div class="row absolute-bottom bg-light-8" style="background: rgba(255,255,255,.7)">
          <div class="col-12 q-pa-md">
            <q-input hide-bottom-space borderless input-class="text-md text-mb-md text-weight-medium" v-model="form.name"/>
            <q-input hide-bottom-space borderless input-class="text-xs text-mb-sm" autogrow v-model="form.description"/>
          </div>
      ...
      <div class="t-l q-ma-sm" @click.stop="avatarDialog = true">
        <default-avatar square style="width: 150px; height: 150px" :value="form" size-in="150px"/>
